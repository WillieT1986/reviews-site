...
public class ReviewRepository {
	...
	public ReviewRepository() {
		Review anime = new Review(1L, "Gosick", "./images/gosick.jpg", "Mystery, Historical, Drama, Romance",
				"A student by the name of Kujou, Kazuya attends a school where he comes across a young girl at the top of a towering Library where they end up talking"
						+ " about Mysteries and Legends. Solving crime scenes and assisting a detective while she remains at the top of the Library using her foresight to help"
						+ "solve crime while Kazuya is known to other students as Black Reaper. They must rely on one another as these two solve the Ghost Ship & The Alchemist.",
		...
		Review manga = new Review(4L, "Übel Blatt", "./images/ubel.jpg", "Action, Adventure, Ecchi, Fantasy, Seinen",
				"This story is about a boy named Kóinzell who's much older than he seems. Once know to be apart of a group of Hero's who ended up being betrayed. "
						+ "Kóinzell, seeks vengeance against the Hero's who betrayed him and his comrades and made them out to be traitors. "
